...
const loader = new RESTLoader({
  getResourceUrl: (id, data, offset) => {
    ...
    return `${BASE}/gyms/${id}/sessions?limit=${LIMIT}&offset=${offset}&private=false&name=${className}&instructor=${instructor}&student=${student}&startDate=${startDate}&endDate=${endDate}`;
  },
